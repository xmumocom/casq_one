...
abstract public class NetworkInterface implements ModuleCommunicationListener {
	...
	public NetworkInterface(Settings s) {
		...
		//把btInterface和highspeedInterface设为同一类型
		if(this.interfacetype.equals("highspeedInterface")||this.interfacetype.equals("btInterface")){
			this.interfacetype="nodeInterface";
		}
	...
	protected boolean isWithinRange(NetworkInterface anotherInterface) {
		...
		if (myRange > smallerRange) {    //选择更大的range
