...
public class MapBasedMovement extends MovementModel implements SwitchableMovement {
	...
	/*
	 * 新添加的getPath方法(non-Javadoc)
	 * @see movement.MovementModel#getPath(core.Coord, core.Coord)
	 */
	@Override
	public Path getPath(Coord from, Coord to) {
		...
		if(fromNode==null) System.out.println("fromNode wrong");
		 if(toNode==null) System.out.println("toNode wrong");
