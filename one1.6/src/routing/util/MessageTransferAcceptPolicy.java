...
//		System.out.println("Accept Sending£º"+m.toString()+", size£º"+m.getSize()+", hopcount£º"+m.getHopCount()+", receivetime£º"+m.getReceiveTime()
//			+", from£º"+m.getFrom().getAddress()+", to£º"+m.getTo().getAddress());
//		
		return true;
	}
